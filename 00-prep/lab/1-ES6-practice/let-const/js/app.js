...
function displayPics(){
  ...
  // Let rando = makeRandom() created an error that disabled the display of images in the web browser.  This occurs because let declarations are limited specifically to the scope of the block whereas var decalares a variable regardless of block scope (MDN docs)
  console.log(viewed);
